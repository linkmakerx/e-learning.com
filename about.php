   ...
   <body>
      ...
      <div class="news_section layout_padding">
         <div class="container">
            ...
            <p class="news_text">Your success is our mission. <br> We dedicate ourselves into making you a very productive member of the computer community.</p>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="news_taital_box">
                        ...
                        <p class="lorem_text">Meet and interact with some of the most dedicated teachers in the country.</p>
                        <p class="post_text">Post By : SPECO</p>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <img src="images/image (2).jpg" class="image_6" style="width:100%">
