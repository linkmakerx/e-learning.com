      ...
      <div class="blog_section layout_padding">
         <div class="container">
            ...
            <div class="blog_section_2">
               <div class="row">
                  <div class="col-md-6">
                     <img src="images/Miss kenyo (1).PNG" class="image_7" style="width:100%" height="100%">
                  </div>
                  <div class="col-md-6">
                     <h4 class="classes_text">Best Classes and study</h4>
                     <p class="ipsum_text">Read about computer science trends that will blow your mind.</p>
                  </div>
               </div>
            </div>
